...
var Endpoint = (function () {
  ...
  _createClass(Endpoint, [{
    ...
    value: function create(conf) {
      return this._setCRSFHeader(_superagent2['default'].post(this.url)).send(conf);
    }
  }, {
    key: 'update',
    value: function update(conf, id) {
      return this._setCRSFHeader(_superagent2['default'].put(this._getObjectURL(id))).send(conf);
    }
  }, {
    key: '_getObjectURL',
    ...
    key: '_setCRSFHeader',
    value: function _setCRSFHeader(request) {
